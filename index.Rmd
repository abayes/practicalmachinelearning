...
Test_Data_Results <- confusionMatrix(testpred, testing$classe)
```
...
The expected out of sample error rate can be found by running the model on the 40% of the original data that was held out for testing. Using 1 - Accuracy as the error rate, the out of sample error rate can be estimated as `r 1- Test_Data_Results$overall[1]` for this model
